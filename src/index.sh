...
versions() {
    ...
    [[ $selected = 2 ]] && chmod +x home.sh && ./home.sh
    [[ $selected = 3 ]] && chmod +x premium.sh && ./premium.sh
    [[ $selected = 4 ]] && chmod +x ultimate.sh && ./ultimate.sh
    [[ $selected = 5 ]] && chmod +x custom.sh && ./custom.sh
    [[ $selected = 6 ]] && \
        lechoe "\nAborting..." "\nAbortando..."
        exit 0
}
