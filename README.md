...
### Logo:
- brandmark: [Fastfetch Source](https://github.com/fastfetch-cli/fastfetch/blob/dev/src/logo/ascii/windows.txt)
- stylized logotype: [ASCII Art Archive](https://www.asciiart.eu/text-to-ascii-art), [Text to ASCII Generator](https://patorjk.com/software/taag), [ASCII Banner - ManyTools](https://manytools.org/hacker-tools/ascii-banner/)
